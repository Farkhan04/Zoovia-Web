...
<h4 class="fw-bold py-2 mb-3">
    <span class="text-muted fw-light">Admin / Dokter /</span> Tambah Dokter
</h4>
                ...
                <form action="{{ route('admin.dokter.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_dokter') is-invalid @enderror" id="nama_dokter" name="nama_dokter" value="{{ old('nama_dokter') }}" placeholder="Masukkan nama dokter" required>
                            @error('nama_dokter')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat dokter" required>{{ old('alamat') }}</textarea>
                        @error('alamat')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('no_telepon') is-invalid @enderror" id="no_telepon" name="no_telepon" value="{{ old('no_telepon') }}" placeholder="8123456789" required>
                            @error('no_telepon')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <img id="preview" src="{{ asset('Admin/assets/img/avatars/default-doctor.png') }}" alt="Preview" class="img-thumbnail" style="height: 150px; width: 150px; object-fit: cover;">
                            </div>
                        </div>
                    </div>
