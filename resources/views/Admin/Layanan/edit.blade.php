...
<h4 class="fw-bold py-2 mb-3">
    <span class="text-muted fw-light">Admin / Layanan /</span> Edit Layanan
</h4>
                ...
                <form action="{{ route('admin.layanan.update', $layanan->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" class="form-control @error('nama_layanan') is-invalid @enderror" id="nama_layanan" name="nama_layanan" value="{{ old('nama_layanan', $layanan->nama_layanan) }}" placeholder="Masukkan nama layanan" required>
                            @error('nama_layanan')
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('harga_layanan') is-invalid @enderror" id="harga_layanan" name="harga_layanan" value="{{ old('harga_layanan', str_replace('Rp ', '', $layanan->harga_layanan)) }}" placeholder="Contoh: 150.000" required>
                                @error('harga_layanan')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="time" class="form-control @error('jam_operasional_mulai') is-invalid @enderror" id="jam_operasional_mulai" name="jam_operasional_mulai" value="{{ old('jam_operasional_mulai', $layanan->jam_operasional_mulai ?? '08:00') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="time" class="form-control @error('jam_operasional_selesai') is-invalid @enderror" id="jam_operasional_selesai" name="jam_operasional_selesai" value="{{ old('jam_operasional_selesai', $layanan->jam_operasional_selesai ?? '17:00') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi_layanan') is-invalid @enderror" id="deskripsi_layanan" name="deskripsi_layanan" rows="4" placeholder="Masukkan deskripsi lengkap tentang layanan" required>{{ old('deskripsi_layanan', $layanan->deskripsi_layanan) }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <div class="border rounded p-2">
                                    <img id="preview" src="{{ $layanan->foto_layanan ? asset('storage/'.$layanan->foto_layanan) : asset('Admin/assets/img/illustrations/service-placeholder.png') }}" alt="Preview" class="img-fluid rounded" style="max-height: 150px;">
                                </div>
                            </div>
                        </div>
                    </div>
