            ...
            <div class="card-body">
                <form action="{{ route('admin.layanan.index') }}" method="GET" class="row g-3">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="{{ route('admin.layanan.create') }}" class="btn btn-outline-primary w-100">
                        ...
                        <tbody>
                            @forelse($layanans as $index => $layanan)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('admin.layanan.show', $layanan->id) }}" class="btn btn-icon btn-sm btn-primary me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Detail">
                                                <i class="bx bx-show"></i>
                                            </a>
                                            <a href="{{ route('admin.layanan.edit', $layanan->id) }}" class="btn btn-icon btn-sm btn-info me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.layanan.destroy', $layanan->id) }}" method="POST" class="d-inline delete-form">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-icon btn-sm btn-danger btn-delete" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus" data-name="{{ $layanan->nama_layanan }}">
