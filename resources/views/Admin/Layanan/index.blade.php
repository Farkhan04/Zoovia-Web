                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center">
                                                                ...
                                                                @else
                                                                    <div class="bg-label-primary d-flex align-items-center justify-content-center rounded"
                                                        ...
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <small class="text-muted">
                                                                    ...
                                                                    {{ $layanan->jam_operasional_mulai ?? '08:00' }} - {{
                                $layanan->jam_operasional_selesai ?? '17:00' }}
                                                                </small>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <p class="text-truncate mb-0" style="max-width: 200px;"
                                                                title="{{ $layanan->deskripsi_layanan }}">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="progress w-75" style="height: 8px;">
                                                                    <div class="progress-bar bg-primary" role="progressbar"
                                                                        ...
                                                                        aria-valuenow="{{ $layanan->dokters->count() }}" aria-valuemin="0"
                                                                        aria-valuemax="5"></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('admin.layanan.show', $layanan->id) }}"
                                                                    class="btn btn-icon btn-md btn-primary me-1" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" title="Detail">
                                                                    <i class="bx bx-show" style="color: white;"></i>
                                                                </a>
                                                                <a href="{{ route('admin.layanan.edit', $layanan->id) }}"
                                                                    class="btn btn-icon btn-md btn-info me-1" data-bs-toggle="tooltip"
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse"
                    data-bs-target="#cardView" aria-expanded="false" aria-controls="cardView">
                                                ...
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.layanan.show', $layanan->id) }}">
                                                                    ...
                                                                    <form action="{{ route('admin.layanan.destroy', $layanan->id) }}"
                                                                        ...
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit" class="dropdown-item btn-delete-card"
                                                                            data-name="{{ $layanan->nama_layanan }}">
                                                        ...
                                                        <div class="d-flex align-items-center position-relative mb-3">
                                                            @if($layanan->foto_layanan)
                                                                <img src="{{ asset('storage/' . $layanan->foto_layanan) }}"
                                                                    alt="{{ $layanan->nama_layanan }}" class="w-100 rounded"
                                                                    style="height: 150px; object-fit: cover;">
                                                            @else
                                                                <div class="w-100 bg-label-primary d-flex align-items-center justify-content-center rounded"
                                                                    style="height: 150px;">
                                                            ...
                                                            <div class="position-absolute bottom-0 start-0 ms-3 mb-3">
                                                                <span class="badge bg-primary">{{ $layanan->dokters->count() }}
                                                                    Dokter</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                ...
                                                                <small><i class="bx bx-time text-primary me-1"></i>{{
                            $layanan->jam_operasional_mulai ?? '08:00' }} - {{
                            $layanan->jam_operasional_selesai ?? '17:00' }}</small>
                                                            </div>
                                                            <a href="{{ route('admin.layanan.show', $layanan->id) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            searchInput.addEventListener('keypress', function (e) {
                if (e.key === 'Enter') {
                    e.preventDefault(); // Prevent default action of Enter key (form submission)
                    performSearch(searchInput.value);
                }
            });

            // Perform search function that reloads the page with the query
            function performSearch(query) {
                // Reload the page with the updated search query in the URL
                window.location.href = `{{ route('admin.layanan.index') }}?search=${query}`;
            }
        });
