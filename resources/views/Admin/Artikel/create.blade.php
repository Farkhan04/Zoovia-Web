...
<h4 class="fw-bold py-2 mb-3">
    <span class="text-muted fw-light">Admin / Artikel /</span> Tambah Artikel
</h4>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                <img id="preview" src="{{ asset('Admin/assets/img/illustrations/no-image.png') }}" 
                                    alt="Preview" class="img-fluid rounded" style="max-height: 120px; width: auto;">
                            </div>
                        </div>
                    </div>
