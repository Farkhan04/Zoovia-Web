                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    ...
                                    <p>Pelayanan darurat untuk hewan peliharaan yang membutuhkan penanganan segera dari tenaga medis yang terlatih. </p>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="dept_thumb">
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    ...
                                    <p>Layanan konsultasi dengan dokter hewan berpengalaman untuk memberikan solusi terbaik bagi masalah kesehatan hewan Anda. </p>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="dept_thumb">
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    ...
                                    <p>Perawatan rutin dan vaksinasi untuk menjaga kesehatan hewan peliharaan Anda agar tetap prima. </p>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="dept_thumb">
